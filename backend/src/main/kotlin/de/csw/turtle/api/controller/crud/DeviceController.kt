...
class DeviceController(
    ...
    override val createPermission: Permission = Permission.BACKEND__API_DEVICES__CREATE,
    override val getPermission: Permission = Permission.BACKEND__API_DEVICES__GET,
    override val patchPermission: Permission = Permission.BACKEND__API_DEVICES__PATCH,
    override val deletePermission: Permission = Permission.BACKEND__API_DEVICES__DELETE,
