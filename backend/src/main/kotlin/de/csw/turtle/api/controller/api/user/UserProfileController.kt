...
class UserProfileController(
    ...
    fun get(): ResponseEntity<GetUserResponse> {
        val user = securityService.check(BACKEND__API_USER_PROFILE__GET)!!
    ...
    fun patch(
        ...
        val user = securityService.check(BACKEND__API_USER_PROFILE__PATCH)!!
    ...
    fun delete(): ResponseEntity<GetUserResponse> {
        val user = securityService.check(BACKEND__API_USER_PROFILE__DELETE)!!
