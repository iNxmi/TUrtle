...
import de.csw.turtle.api.security.Permission.API_AUDIT_LOGS_GET_ONE
import de.csw.turtle.api.security.Permission.API_AUDIT_LOGS_GET_PAGINATED
...
class AuditLogController(
    ...
    @RequiresPermission(API_AUDIT_LOGS_GET_PAGINATED)
    @GetMapping
    fun getPaginated(
    ...
    @RequiresPermission(API_AUDIT_LOGS_GET_ONE)
    @GetMapping("/{id}")
