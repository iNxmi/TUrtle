...
class LockerController(
    ...
    override val permissionCreate: Permission = Permission.BACKEND__API_LOCKERS__CREATE,
    override val permissionGet: Permission = Permission.BACKEND__API_LOCKERS__GET,
    override val permissionPatch: Permission = Permission.BACKEND__API_LOCKERS__PATCH,
    override val permissionDelete: Permission = Permission.BACKEND__API_LOCKERS__DELETE,
