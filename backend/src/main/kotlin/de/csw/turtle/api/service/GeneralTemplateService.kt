...
class GeneralTemplateService(
    ...
    override val mapper: GeneralTemplateMapper
) : CRUDService<GeneralTemplateEntity, CreateGeneralTemplateRequest, GetGeneralTemplateResponse, PatchGeneralTemplateRequest>("General Template") {
