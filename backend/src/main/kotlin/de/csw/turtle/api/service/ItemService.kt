...
class ItemService(
    ...
    fun create(
        ...
        val maxNameLength = configurationService.getTyped<Int>(ConfigurationEntity.Key.ITEM_NAME_LENGTH)
        ...
        val maxDescriptionLength = configurationService.getTyped<Int>(ConfigurationEntity.Key.ITEM_DESCRIPTION_LENGTH)
