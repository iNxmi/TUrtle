...
<script>
    ...
    let items = [
        { name: '-0.5s', rarity: 'gray', weight: 13, function: () => { seconds -= 0.5 } },
        { name: '+0.5s', rarity: 'blue', weight: 8, function: () => { seconds += 0.5 } },
        { name: '+1.0s', rarity: 'purple', weight: 4, function: () => { seconds += 1.0 } },
        { name: '+2.0s', rarity: 'pink', weight: 4, function: () => { seconds += 2.0 } },
        { name: '+5.0s', rarity: 'red', weight: 4, function: () => { seconds += 5.0 } },
...
<!--        &lt;!&ndash; Magnifying lens &ndash;&gt;-->
<!--        <div class="lens">-->
<!--            <div class="reel {animateClass}" style="transform: translateX({offset}px) scale(1.5);">-->
<!--                {#each reel as item}-->
<!--                    <div class="item {item.rarity}">{item.name}</div>-->
<!--                {/each}-->
<!--            </div>-->
...
<style>
    ...
    .blue { background: #4b69ff; }
    .purple { background: #8847ff; }
    .pink { background: #d32ce6; }
    .red { background: #eb4b4b; }
    .gold { background: #e4ae39; }
