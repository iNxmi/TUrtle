<script>
    ...
    async function register(event) {
        ...
        loading = true;
        const registerResponse = await Users.create(payload);
        loading = false;
        ...
        //TODO this is auto login code, but rather use modal to let user know that registration was succssful and verify in email
        // loading = true;
