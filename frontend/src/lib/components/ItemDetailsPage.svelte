...
{#snippet textWithLabel(label, content, endpoint)}
    <div class="flex flex-col">
        ...
        {#if endpoint}
            <a href={`/manage${endpoint}`} class="text-csw">{content}</a>
...
<div class="flex flex-col justify-center items-center">
    <div class="w-full flex bg-white border rounded-lg max-w-2xl border-gray-200 dark:bg-gray-800 dark:border-gray-700 shadow-md flex-col p-5 grow"
         size="lg">
